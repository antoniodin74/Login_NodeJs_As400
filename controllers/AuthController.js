...
module.exports = function (app) {
	...
	//MD25/01/2023
	app.post('/loginAs', urlencodeParser, function (req, res) {
		let tempUser = { username: req.body.username, password: req.body.userpassword };
		try {
			sess = req.session;
			sess.user = tempUser;
			res.status(tempUser? 200: 404).json(tempUser? tempUser : null);
		} catch (e) {
